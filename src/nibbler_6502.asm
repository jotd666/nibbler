...
; col: $2-$1A
snake_head_col_52 = $52
; $53: head direction
; direction: 1 down
; direction: 2 up
; direction: 4 right
; direction: 8 left
snake_head_direction_53 = $53
...
39FF: A9 1B    lda #$1b
3A01: 38       sec
3A02: E5 51    sbc snake_head_row_51
3A04: 18       clc
3A05: 2A       rol a
3A06: 2A       rol a
3A07: 2A       rol a
...
3A16: A9 1F    lda #$1f
3A18: 38       sec
3A19: E5 52    sbc snake_head_col_52
3A1B: 18       clc
3A1C: 65 5C    adc $5c
3A1E: 85 5C    sta $5c
3A20: A5 5C    lda $5c
...
3A4A: A5 53    lda snake_head_direction_53
3A4C: A2 0D    ldx #$0d
3A4E: A0 00    ldy #$00
3A50: C9 01    cmp #$01
3A52: F0 14    beq $3a68
...
3A8B: A5 53    lda snake_head_direction_53
3A8D: 49 0F    eor #$0f
...
3ADC: A5 53    lda snake_head_direction_53
3ADE: 25 18    and $18
3AE0: F0 0C    beq $3aee
...
3B75: 25 53    and snake_head_direction_53
3B77: F0 0C    beq $3b85
3B79: A5 17    lda head_x_value_17
3B7B: 38       sec
3B7C: E5 53    sbc snake_head_direction_53
...
3BD3: 85 53    sta snake_head_direction_53
3BD5: A5 53    lda snake_head_direction_53
3BD7: C9 03    cmp #$03
3BD9: 10 07    bpl $3be2
3BDB: A5 51    lda snake_head_row_51
3BDD: 85 17    sta head_x_value_17
3BDF: 4C E6 3B jmp $3be6
3BE2: A5 52    lda snake_head_col_52
...
3C0C: 85 5E    sta $5e
3C0E: 85 5A    sta $5a
3C10: A5 51    lda snake_head_row_51
3C12: 85 3B    sta move_to_row_3b
3C14: A5 52    lda snake_head_col_52
3C16: 85 3C    sta $3c
3C18: A9 10    lda #$10
...
3C2B: A5 53    lda snake_head_direction_53
3C2D: C9 01    cmp #$01
...
3C90: B1 19    lda ($19), y
3C92: 85 34    sta $34
3C94: A5 53    lda snake_head_direction_53
3C96: C9 08    cmp #$08
...
3CDF: A5 53    lda snake_head_direction_53
3CE1: C9 01    cmp #$01
...
3D17: 18       clc
3D18: 65 51    adc snake_head_row_51
3D1A: 85 19    sta $19
3D1C: A0 08    ldy #$08
3D1E: B1 17    lda (head_x_value_17), y
3D20: 18       clc
3D21: 65 52    adc snake_head_col_52
3D23: 85 1A    sta $1a
3D25: A0 10    ldy #$10
...
3DDB: E9 08    sbc #$08
3DDD: 85 5E    sta $5e
3DDF: A5 53    lda snake_head_direction_53
3DE1: C9 01    cmp #$01
3DE3: F0 0D    beq $3df2
3DE5: C9 02    cmp #$02
3DE7: F0 0E    beq $3df7
3DE9: C9 04    cmp #$04
3DEB: F0 0F    beq $3dfc
3DED: C6 51    dec snake_head_row_51
3DEF: 4C FE 3D jmp $3dfe
3DF2: C6 52    dec snake_head_col_52
3DF4: 4C FE 3D jmp $3dfe
3DF7: E6 52    inc snake_head_col_52
3DF9: 4C FE 3D jmp $3dfe
3DFC: E6 51    inc snake_head_row_51
3DFE: A9 1B    lda #$1b
3E00: 38       sec
3E01: E5 51    sbc snake_head_row_51
3E03: 18       clc
3E04: 2A       rol a
3E05: 2A       rol a
3E06: 2A       rol a
...
3E15: A9 1F    lda #$1f
3E17: 38       sec
3E18: E5 52    sbc snake_head_col_52
3E1A: 18       clc
3E1B: 65 28    adc $28
3E1D: 85 28    sta $28
3E1F: A5 29    lda $29
...
3F57: A5 53    lda snake_head_direction_53
3F59: C9 01    cmp #$01
3F5B: F0 0B    beq $3f68
3F5D: C9 02    cmp #$02
3F5F: F0 0A    beq $3f6b
3F61: C9 04    cmp #$04
3F63: F0 09    beq $3f6e
3F65: E6 51    inc snake_head_row_51
3F67: 60       rts
3F68: E6 52    inc snake_head_col_52
3F6A: 60       rts
3F6B: C6 52    dec snake_head_col_52
3F6D: 60       rts
3F6E: C6 51    dec snake_head_row_51
3F70: 60       rts
3F71: C9 01    cmp #$01
3F73: F0 11    beq $3f86
3F75: C9 02    cmp #$02
...
4F2E: C9 04    cmp #$04
4F30: F0 06    beq $4f38
4F32: C6 54    dec snake_tail_row_54
4F34: D0 17    bne $4f4d
4F36: F0 10    beq $4f48
4F38: E6 54    inc snake_tail_row_54
4F3A: D0 11    bne $4f4d
4F3C: F0 0A    beq $4f48
4F3E: E6 55    inc snake_tail_col_55
4F40: D0 0B    bne $4f4d
4F42: F0 04    beq $4f48
4F44: C6 55    dec snake_tail_col_55
4F46: D0 05    bne $4f4d
4F48: A9 82    lda #$82
...
4F58: A5 56    lda snake_tail_direction_56
4F5A: C9 01    cmp #$01
4F5C: F0 20    beq $4f7e
4F5E: C9 02    cmp #$02
4F60: F0 14    beq $4f76
...
4F64: F0 08    beq $4f6e
4F66: B1 E2    lda ($e2), y
4F68: C5 54    cmp snake_tail_row_54
4F6A: 30 2C    bmi $4f98
4F6C: 10 16    bpl $4f84
4F6E: A5 54    lda snake_tail_row_54
4F70: D1 E2    cmp ($e2), y
4F72: 30 24    bmi $4f98
4F74: 10 0E    bpl $4f84
4F76: A5 55    lda snake_tail_col_55
4F78: D1 E2    cmp ($e2), y
4F7A: 30 1C    bmi $4f98
4F7C: 10 06    bpl $4f84
4F7E: B1 E2    lda ($e2), y
4F80: C5 55    cmp snake_tail_col_55
4F82: 30 14    bmi $4f98
...
4FAB: A5 52    lda snake_head_col_52
4FAD: 85 32    sta $32
4FAF: A5 53    lda snake_head_direction_53
4FB1: C9 01    cmp #$01
4FB3: F0 1A    beq $4fcf
4FB5: C9 02    cmp #$02
4FB7: F0 10    beq $4fc9
4FB9: C9 04    cmp #$04
4FBB: F0 06    beq $4fc3
4FBD: C6 51    dec snake_head_row_51
4FBF: D0 17    bne $4fd8
4FC1: F0 10    beq $4fd3
4FC3: E6 51    inc snake_head_row_51
4FC5: D0 11    bne $4fd8
4FC7: F0 0A    beq $4fd3
4FC9: E6 52    inc snake_head_col_52
4FCB: D0 0B    bne $4fd8
4FCD: F0 04    beq $4fd3
4FCF: C6 52    dec snake_head_col_52
4FD1: D0 05    bne $4fd8
4FD3: A9 85    lda #$85
...
5543: A9 1B    lda #$1b
5545: 38       sec
5546: E5 51    sbc snake_head_row_51
5548: 18       clc
5549: 2A       rol a
554A: 2A       rol a
554B: 2A       rol a
...
555A: A9 1F    lda #$1f
555C: 38       sec
555D: E5 52    sbc snake_head_col_52
555F: 18       clc
5560: 65 1D    adc $1d
5562: 85 1D    sta $1d
5564: A5 53    lda snake_head_direction_53
5566: C9 01    cmp #$01
5568: F0 57    beq $55c1
556A: C9 02    cmp #$02
556C: F0 43    beq $55b1
...
5626: A9 1B    lda #$1b
5628: 38       sec
5629: E5 54    sbc snake_tail_row_54
562B: 18       clc
562C: 2A       rol a
562D: 2A       rol a
562E: 2A       rol a
...
563D: A9 1F    lda #$1f
563F: 38       sec
5640: E5 55    sbc snake_tail_col_55
5642: 18       clc
5643: 65 1B    adc $1b
5645: 85 1B    sta $1b
5647: A0 00    ldy #$00
...
5679: C9 04    cmp #$04
567B: F0 0F    beq $568c
567D: C6 54    dec snake_tail_row_54
567F: 4C 8E 56 jmp $568e
5682: C6 55    dec snake_tail_col_55
5684: 4C 8E 56 jmp $568e
5687: E6 55    inc snake_tail_col_55
5689: 4C 8E 56 jmp $568e
568C: E6 54    inc snake_tail_row_54
568E: A9 1B    lda #$1b
5690: 38       sec
5691: E5 54    sbc snake_tail_row_54
5693: 18       clc
5694: 2A       rol a
5695: 2A       rol a
5696: 2A       rol a
...
56A5: A9 1F    lda #$1f
56A7: 38       sec
56A8: E5 55    sbc snake_tail_col_55
56AA: 18       clc
56AB: 65 1B    adc $1b
56AD: 85 1B    sta $1b
56AF: A0 00    ldy #$00
...
56BE: A5 51    lda snake_head_row_51
56C0: C5 54    cmp snake_tail_row_54
56C2: D0 97    bne $565b
56C4: A5 52    lda snake_head_col_52
56C6: C5 55    cmp snake_tail_col_55
56C8: D0 91    bne $565b
56CA: A5 53    lda snake_head_direction_53
56CC: A2 42    ldx #$42
56CE: C9 01    cmp #$01
56D0: F0 0E    beq $56e0
56D2: A2 21    ldx #$21
...
587A: A5 56    lda snake_tail_direction_56
587C: C9 01    cmp #$01
587E: F0 23    beq $58a3
5880: C9 02    cmp #$02
5882: F0 16    beq $589a
...
588B: C5 54    cmp snake_tail_row_54
588D: 30 45    bmi $58d4
588F: 10 19    bpl $58aa
5891: A5 54    lda snake_tail_row_54
5893: D9 C0 03 cmp $03c0, y
5896: 30 3C    bmi $58d4
5898: 10 10    bpl $58aa
589A: A5 55    lda snake_tail_col_55
589C: D9 C0 03 cmp $03c0, y
589F: 30 33    bmi $58d4
58A1: 10 07    bpl $58aa
58A3: B9 C0 03 lda $03c0, y
58A6: C5 55    cmp snake_tail_col_55
58A8: 30 2A    bmi $58d4
58AA: C8       iny
...
58C8: 10 02    bpl $58cc
58CA: A2 08    ldx #$08
58CC: 86 56    stx snake_tail_direction_56
58CE: C8       iny
58CF: 98       tya
58D0: 29 3F    and #$3f
...
5C9D: A5 53    lda snake_head_direction_53
5C9F: C9 01    cmp #$01
5CA1: F0 2C    beq $5ccf
5CA3: C9 02    cmp #$02
5CA5: F0 1C    beq $5cc3
...
5CAD: 38       sec
5CAE: E5 51    sbc snake_head_row_51
5CB0: C9 02    cmp #$02
5CB2: 10 27    bpl $5cdb
5CB4: 4C DE 5C jmp $5cde
5CB7: A5 51    lda snake_head_row_51
5CB9: 38       sec
5CBA: E5 3B    sbc move_to_row_3b
5CBC: C9 02    cmp #$02
5CBE: 10 1B    bpl $5cdb
5CC0: 4C DE 5C jmp $5cde
5CC3: A5 52    lda snake_head_col_52
5CC5: 38       sec
5CC6: E5 3C    sbc $3c
5CC8: C9 02    cmp #$02
5CCA: 10 0F    bpl $5cdb
...
5CCF: A5 3C    lda $3c
5CD1: 38       sec
5CD2: E5 52    sbc snake_head_col_52
5CD4: C9 02    cmp #$02
5CD6: 10 03    bpl $5cdb
5CD8: 4C DE 5C jmp $5cde
5CDB: 20 00 AF jsr $af00
5CDE: A5 53    lda snake_head_direction_53
5CE0: C9 04    cmp #$04
...
5DF9: 08       php
5DFA: A9 02    lda #$02
5DFC: 85 52    sta snake_head_col_52
5DFE: 85 55    sta snake_tail_col_55
5E00: A9 10    lda #$10
5E02: 85 51    sta snake_head_row_51
5E04: A9 08    lda #$08
5E06: 85 54    sta snake_tail_row_54
5E08: A9 04    lda #$04
5E0A: 85 53    sta snake_head_direction_53
5E0C: 85 56    sta snake_tail_direction_56
5E0E: A9 01    lda #$01
...
5E8E: D0 F5    bne $5e85
5E90: 60       rts
5E91: A5 56    lda snake_tail_direction_56
5E93: C9 01    cmp #$01
5E95: F0 12    beq $5ea9
5E97: C9 02    cmp #$02
5E99: F0 13    beq $5eae
...
5EB7: A5 54    lda snake_tail_row_54
5EB9: 85 19    sta $19
5EBB: A5 55    lda snake_tail_col_55
5EBD: 85 1A    sta $1a
5EBF: A9 1B    lda #$1b
5EC1: 38       sec
5EC2: E5 19    sbc $19
...
5F02: F0 20    beq $5f24
5F04: A9 04    lda #$04
5F06: 85 56    sta snake_tail_direction_56
...
5F24: A9 08    lda #$08
5F26: 85 56    sta snake_tail_direction_56
...
5F44: A9 01    lda #$01
5F46: 85 56    sta snake_tail_direction_56
...
5F64: A9 02    lda #$02
5F66: 85 56    sta snake_tail_direction_56
...
7F70: E8       inx
7F71: A5 51    lda snake_head_row_51
7F73: 9D 00 02 sta $0200, x
7F76: E8       inx
7F77: A5 52    lda snake_head_col_52
7F79: 9D 00 02 sta $0200, x
7F7C: E8       inx
7F7D: A5 53    lda snake_head_direction_53
...
A050: A5 53    lda snake_head_direction_53
A052: C9 04    cmp #$04
A054: F0 1B    beq $a071
A056: A5 3B    lda move_to_row_3b
A058: 38       sec
A059: E5 51    sbc snake_head_row_51
A05B: 30 0F    bmi $a06c
A05D: C9 04    cmp #$04
A05F: 30 2C    bmi $a08d
A061: A9 3A    lda #$3a
...
A071: A5 51    lda snake_head_row_51
A073: 38       sec
...
A0B6: 88       dey
A0B7: 10 FB    bpl $a0b4
A0B9: A5 53    lda snake_head_direction_53
A0BB: C9 04    cmp #$04
A0BD: F0 10    beq $a0cf
...
A19D: 85 1F    sta $1f
A19F: A4 16    ldy $16
A1A1: A5 53    lda snake_head_direction_53
A1A3: C9 08    cmp #$08
...
A1E0: A5 53    lda snake_head_direction_53
A1E2: C9 08    cmp #$08
...
A20D: C6 16    dec $16
A20F: A4 16    ldy $16
A211: A5 53    lda snake_head_direction_53
A213: C9 08    cmp #$08
A215: F0 0A    beq $a221
...
A24F: 85 1E    sta $1e
A251: A4 1F    ldy $1f
A253: A5 53    lda snake_head_direction_53
A255: C9 08    cmp #$08
A257: F0 0A    beq $a263
...
A307: A5 53    lda snake_head_direction_53
A309: C9 02    cmp #$02
A30B: F0 0E    beq $a31b
A30D: A5 52    lda snake_head_col_52
A30F: 18       clc
A310: 69 02    adc #$02
A312: 85 34    sta $34
A314: A5 52    lda snake_head_col_52
A316: 85 18    sta $18
A318: 4C 26 A3 jmp $a326
A31B: A5 52    lda snake_head_col_52
A31D: 38       sec
A31E: E9 02    sbc #$02
A320: 85 34    sta $34
A322: A5 52    lda snake_head_col_52
A324: 85 18    sta $18
A326: A5 51    lda snake_head_row_51
...
A354: A5 32    lda $32
A356: 85 34    sta $34
A358: A5 53    lda snake_head_direction_53
A35A: C9 02    cmp #$02
A35C: F0 1B    beq $a379
A35E: A5 3C    lda $3c
A360: 38       sec
A361: E5 52    sbc snake_head_col_52
A363: 30 0F    bmi $a374
A365: C9 04    cmp #$04
A367: 30 3B    bmi $a3a4
A369: A9 86    lda #$86
...
A379: A5 52    lda snake_head_col_52
A37B: 38       sec
A37C: E5 3C    sbc $3c
A37E: 30 F4    bmi $a374
A380: C9 04    cmp #$04
...
A3CD: 88       dey
A3CE: 10 FB    bpl $a3cb
A3D0: A5 53    lda snake_head_direction_53
A3D2: C9 02    cmp #$02
A3D4: F0 10    beq $a3e6
...
A4A3: 0A       asl a
A4A4: A8       tay
A4A5: A5 53    lda snake_head_direction_53
A4A7: C9 01    cmp #$01
...
A4FA: 85 1F    sta $1f
A4FC: A4 16    ldy $16
A4FE: A5 53    lda snake_head_direction_53
A500: C9 08    cmp #$08
...
A539: 85 1E    sta $1e
A53B: A4 1F    ldy $1f
A53D: A5 53    lda snake_head_direction_53
A53F: C9 08    cmp #$08
...
A56A: C6 16    dec $16
A56C: A4 16    ldy $16
A56E: A5 53    lda snake_head_direction_53
A570: C9 08    cmp #$08
...
A5AC: 85 1E    sta $1e
A5AE: A4 1F    ldy $1f
A5B0: A5 53    lda snake_head_direction_53
A5B2: C9 08    cmp #$08
A5B4: F0 0A    beq $a5c0
...
A610: A5 55    lda snake_tail_col_55
A612: 85 18    sta $18
A614: A9 1B    lda #$1b
A616: 38       sec
...
A631: 65 19    adc $19
A633: 85 19    sta $19
A635: A5 56    lda snake_tail_direction_56
A637: C9 01    cmp #$01
A639: F0 38    beq $a673
A63B: C9 02    cmp #$02
A63D: F0 24    beq $a663
...
A6EB: 29 F0    and #$f0
A6ED: A8       tay
A6EE: A5 56    lda snake_tail_direction_56
A6F0: C9 01    cmp #$01
A6F2: F0 2C    beq $a720
A6F4: C9 02    cmp #$02
A6F6: F0 1C    beq $a714
A6F8: C9 04    cmp #$04
A6FA: F0 0C    beq $a708
A6FC: A5 54    lda snake_tail_row_54
A6FE: 38       sec
A6FF: E5 16    sbc $16
A701: E9 03    sbc #$03
A703: 10 38    bpl $a73d
...
A708: A5 16    lda $16
A70A: 38       sec
A70B: E5 54    sbc snake_tail_row_54
A70D: E9 03    sbc #$03
A70F: 10 2C    bpl $a73d
A711: 4C C5 A7 jmp $a7c5
A714: A5 16    lda $16
A716: 38       sec
A717: E5 55    sbc snake_tail_col_55
A719: E9 03    sbc #$03
A71B: 10 20    bpl $a73d
...
A721: C9 30    cmp #$30
A723: F0 0C    beq $a731
A725: A5 55    lda snake_tail_col_55
A727: 38       sec
A728: E5 16    sbc $16
A72A: E9 03    sbc #$03
A72C: 10 0F    bpl $a73d
A72E: 4C C5 A7 jmp $a7c5
A731: A5 55    lda snake_tail_col_55
A733: 38       sec
A734: E5 16    sbc $16
A736: E9 04    sbc #$04
A738: 10 03    bpl $a73d
...
A74F: 69 08    adc #$08
A751: 85 1C    sta $1c
A753: A5 56    lda snake_tail_direction_56
A755: C9 03    cmp #$03
A757: 10 03    bpl $a75c
A759: 4C 5C A7 jmp $a75c
A75C: A5 56    lda snake_tail_direction_56
A75E: C9 01    cmp #$01
A760: F0 1A    beq $a77c
A762: C9 02    cmp #$02
A764: F0 0B    beq $a771
...
A792: 85 18    sta $18
A794: A0 07    ldy #$07
A796: A5 56    lda snake_tail_direction_56
A798: C9 08    cmp #$08
A79A: F0 0A    beq $a7a6
...
A7E3: A5 56    lda snake_tail_direction_56
A7E5: C9 01    cmp #$01
A7E7: F0 17    beq $a800
A7E9: C9 02    cmp #$02
A7EB: F0 26    beq $a813
...
A89A: 85 1C    sta $1c
A89C: A4 1E    ldy $1e
A89E: A5 56    lda snake_tail_direction_56
A8A0: C9 08    cmp #$08
A8A2: F0 0A    beq $a8ae
...
A8D1: 85 1C    sta $1c
A8D3: A4 1D    ldy $1d
A8D5: A5 56    lda snake_tail_direction_56
A8D7: C9 08    cmp #$08
A8D9: F0 0A    beq $a8e5
...
A90D: 85 1C    sta $1c
A90F: A4 1E    ldy $1e
A911: A5 56    lda snake_tail_direction_56
A913: C9 08    cmp #$08
A915: F0 0A    beq $a921
...
AA04: D0 10    bne $aa16
AA06: A9 04    lda #$04
AA08: C5 53    cmp snake_head_direction_53
AA0A: D0 0A    bne $aa16
AA0C: C5 56    cmp snake_tail_direction_56
AA0E: D0 06    bne $aa16
...
AA2A: A5 54    lda snake_tail_row_54
AA2C: 85 19    sta $19
AA2E: A5 55    lda snake_tail_col_55
AA30: 18       clc
AA31: 69 01    adc #$01
AA33: 85 1A    sta $1a
AA35: A9 1B    lda #$1b
...
AA52: 65 10    adc $10
AA54: 85 10    sta $10
AA56: A5 51    lda snake_head_row_51
AA58: 18       clc
AA59: 69 01    adc #$01
AA5B: 85 19    sta $19
AA5D: A5 52    lda snake_head_col_52
AA5F: 18       clc
AA60: 69 01    adc #$01
AA62: 85 1A    sta $1a
AA64: A9 1B    lda #$1b
